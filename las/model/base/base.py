...
class Base(object):
	def __init__(self,name,batch_size,N_HIDDEN_UNIT,N_HIDDEN_LAYER,end_epoch=10):
		self.N_HU = N_HIDDEN_UNIT
		self.N_HL = N_HIDDEN_LAYER
	...
	def run(self,Sampling, X_train_path, Y_train_path, eval_path):
		...
		self.build_and_train_model(self.N_HU,self.N_HL)
